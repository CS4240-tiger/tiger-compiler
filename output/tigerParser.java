// $ANTLR 3.5.1 C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g 2014-10-06 22:52:53
...
public class tigerParser extends DebugParser {
	...
	public static final String[] ruleNames = new String[] {
		"invalidRule", "block_list", "base_type", "var_declaration", "func_call_tail", 
		"value_tail", "tiger_program", "stat", "stat_seq", "index_expr", "func_param_list", 
		"block_tail", "funct_declaration_tail", "id_list", "ret_type", "binop_p2", 
		"binary_operator", "optional_init", "type_declaration", "funct_declaration", 
		"binop_p1", "expr_list", "expr", "binop_p0", "param", "binop_p3", "value", 
		"type", "constval", "funct_declaration_list", "keywords", "type_declaration_list", 
		"index_oper", "main_function_tail", "declaration_statement", "block", 
		"type_id", "var_declaration_list", "param_list"
	};
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					dbg.location(184,10);
					match(input,COMMA,FOLLOW_COMMA_in_expr_list818); dbg.location(184,16);
	...
	public final void value() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(187,10);
			match(input,ID,FOLLOW_ID_in_value833); dbg.location(187,13);
		...
		try {
			...
			switch (alt27) {
				case 1 :
					...
					{
					dbg.location(189,4);
					match(input,LBRACK,FOLLOW_LBRACK_in_value_tail844); dbg.location(189,11);
					pushFollow(FOLLOW_index_expr_in_value_tail846);
					index_expr();
					state._fsp--;
					dbg.location(189,22);
					match(input,RBRACK,FOLLOW_RBRACK_in_value_tail848); dbg.location(189,29);
					...
					switch (alt26) {
						case 1 :
							...
							{
							dbg.location(189,30);
							match(input,LBRACK,FOLLOW_LBRACK_in_value_tail851); dbg.location(189,37);
	...
	public final void func_call_tail() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(218,5);
			match(input,LPAREN,FOLLOW_LPAREN_in_func_call_tail1008); dbg.location(218,12);
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							dbg.location(222,11);
							match(input,COMMA,FOLLOW_COMMA_in_func_param_list1030); dbg.location(222,17);
