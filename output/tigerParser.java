// $ANTLR 3.5.1 C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g 2014-11-06 22:14:03
...
public class tigerParser extends Parser {
		...
		try {
			...
			switch (alt3) {
				case 1 :
					...
					// AST REWRITE
					// elements: ID, param_list, VOID_KEY, block_list
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt12) {
				case 1 :
					...
					// AST REWRITE
					// elements: type_id, ASSIGN, fixedptlit, id_list, COLON
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final tigerParser.for_stat_return for_stat() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: stat_seq, ASSIGN, index_expr, FOR_KEY, ID, index_expr, TO_KEY
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
