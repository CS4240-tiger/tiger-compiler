// $ANTLR 3.5.1 C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g 2014-10-06 08:00:39
...
public class tigerParser extends DebugParser {
	...
	public static final String[] ruleNames = new String[] {
		"invalidRule", "stat", "funct_declaration", "base_type", "index_expr", 
		"func_call_tail", "param", "value", "optional_init", "funct_declaration_tail", 
		"block_list", "type_id", "main_function_tail", "keywords", "tiger_program", 
		"func_param_list", "id_list", "stat_seq", "type", "index_oper", "block_tail", 
		"type_declaration", "declaration_statement", "type_declaration_list", 
		"var_declaration", "value_tail", "ret_type", "funct_declaration_list", 
		"param_list", "var_declaration_list", "block", "expr_list", "expr", "binary_operator", 
		"constval"
	};
		...
		try {
			...
			switch (alt3) {
				...
				case 2 :
					...
					{
					dbg.location(17,41);
					match(input,VOID_KEY,FOLLOW_VOID_KEY_in_funct_declaration78); dbg.location(17,50);
			...
			dbg.location(17,98);
			match(input,BEGIN_KEY,FOLLOW_BEGIN_KEY_in_funct_declaration90); dbg.location(17,108);
			pushFollow(FOLLOW_block_list_in_funct_declaration92);
			block_list();
			state._fsp--;
			dbg.location(17,119);
			match(input,END_KEY,FOLLOW_END_KEY_in_funct_declaration94); dbg.location(17,127);
	...
	public final void funct_declaration_tail() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(21,5);
			match(input,FUNCTION_KEY,FOLLOW_FUNCTION_KEY_in_funct_declaration_tail108); dbg.location(21,18);
			match(input,ID,FOLLOW_ID_in_funct_declaration_tail110); dbg.location(21,21);
			match(input,LPAREN,FOLLOW_LPAREN_in_funct_declaration_tail112); dbg.location(21,28);
	...
	public final void main_function_tail() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(25,4);
			match(input,MAIN_KEY,FOLLOW_MAIN_KEY_in_main_function_tail128); dbg.location(25,13);
			match(input,LPAREN,FOLLOW_LPAREN_in_main_function_tail130); dbg.location(25,20);
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							dbg.location(34,12);
							match(input,COMMA_SPACE,FOLLOW_COMMA_SPACE_in_param_list165); dbg.location(34,24);
	...
	public final void param() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(37,10);
			match(input,ID,FOLLOW_ID_in_param182); dbg.location(37,13);
			match(input,COLON,FOLLOW_COLON_in_param184); dbg.location(37,19);
	...
	public final void block() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(48,10);
			match(input,BEGIN_KEY,FOLLOW_BEGIN_KEY_in_block227); dbg.location(48,20);
			...
			state._fsp--;
			dbg.location(48,51);
			match(input,END_KEY,FOLLOW_END_KEY_in_block233); dbg.location(48,59);
	...
	public final void type_declaration() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(63,4);
			match(input,TYPE_KEY,FOLLOW_TYPE_KEY_in_type_declaration288); dbg.location(63,13);
			match(input,ID,FOLLOW_ID_in_type_declaration290); dbg.location(63,16);
			match(input,EQ,FOLLOW_EQ_in_type_declaration292); dbg.location(63,19);
		...
		try {
			...
			switch (alt11) {
				...
				case 2 :
					...
					{
					dbg.location(67,4);
					match(input,ARRAY_KEY,FOLLOW_ARRAY_KEY_in_type312); dbg.location(67,14);
					match(input,LBRACK,FOLLOW_LBRACK_in_type314); dbg.location(67,21);
					match(input,INTLIT,FOLLOW_INTLIT_in_type316); dbg.location(67,28);
					match(input,RBRACK,FOLLOW_RBRACK_in_type318); dbg.location(67,35);
					...
					switch (alt10) {
						case 1 :
							...
							{
							dbg.location(67,36);
							match(input,LBRACK,FOLLOW_LBRACK_in_type321); dbg.location(67,43);
							match(input,INTLIT,FOLLOW_INTLIT_in_type323); dbg.location(67,50);
					...
					dbg.location(67,59);
					match(input,OF_KEY,FOLLOW_OF_KEY_in_type329); dbg.location(67,66);
	...
	public final void var_declaration() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(80,4);
			match(input,VAR_KEY,FOLLOW_VAR_KEY_in_var_declaration374); dbg.location(80,12);
			pushFollow(FOLLOW_id_list_in_var_declaration376);
			id_list();
			state._fsp--;
			dbg.location(80,20);
			match(input,COLON,FOLLOW_COLON_in_var_declaration378); dbg.location(80,26);
	...
	public final void id_list() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(83,11);
			match(input,ID,FOLLOW_ID_in_id_list394); dbg.location(83,14);
		...
		try {
			...
			switch (alt14) {
				...
				case 2 :
					...
					{
					dbg.location(88,5);
					match(input,ASSIGN,FOLLOW_ASSIGN_in_optional_init426); dbg.location(88,12);
		...
		try {
			...
			switch (alt18) {
				case 1 :
					...
					{
					dbg.location(96,4);
					match(input,IF_KEY,FOLLOW_IF_KEY_in_stat453); dbg.location(96,11);
					pushFollow(FOLLOW_expr_in_stat455);
					expr();
					state._fsp--;
					dbg.location(96,16);
					match(input,THEN_KEY,FOLLOW_THEN_KEY_in_stat457); dbg.location(96,25);
					...
					switch (alt16) {
						case 1 :
							...
							{
							dbg.location(96,35);
							match(input,ENDIF_KEY,FOLLOW_ENDIF_KEY_in_stat462); dbg.location(96,45);
						...
						case 2 :
							...
							{
							dbg.location(96,50);
							match(input,ELSE_KEY,FOLLOW_ELSE_KEY_in_stat466); dbg.location(96,59);
							pushFollow(FOLLOW_stat_seq_in_stat468);
							stat_seq();
							state._fsp--;
							dbg.location(96,68);
							match(input,ENDIF_KEY,FOLLOW_ENDIF_KEY_in_stat470); dbg.location(96,78);
				...
				case 2 :
					...
					{
					dbg.location(97,4);
					match(input,WHILE_KEY,FOLLOW_WHILE_KEY_in_stat478); dbg.location(97,14);
					pushFollow(FOLLOW_expr_in_stat480);
					expr();
					state._fsp--;
					dbg.location(97,19);
					match(input,DO_KEY,FOLLOW_DO_KEY_in_stat482); dbg.location(97,26);
					pushFollow(FOLLOW_stat_seq_in_stat484);
					stat_seq();
					state._fsp--;
					dbg.location(97,35);
					match(input,ENDDO_KEY,FOLLOW_ENDDO_KEY_in_stat486); dbg.location(97,45);
				...
				case 3 :
					...
					{
					dbg.location(98,4);
					match(input,FOR_KEY,FOLLOW_FOR_KEY_in_stat493); dbg.location(98,12);
					match(input,ID,FOLLOW_ID_in_stat495); dbg.location(98,15);
					match(input,ASSIGN,FOLLOW_ASSIGN_in_stat497); dbg.location(98,22);
					pushFollow(FOLLOW_index_expr_in_stat499);
					index_expr();
					state._fsp--;
					dbg.location(98,33);
					match(input,TO_KEY,FOLLOW_TO_KEY_in_stat501); dbg.location(98,40);
					pushFollow(FOLLOW_index_expr_in_stat503);
					index_expr();
					state._fsp--;
					dbg.location(98,51);
					match(input,DO_KEY,FOLLOW_DO_KEY_in_stat505); dbg.location(98,58);
					pushFollow(FOLLOW_stat_seq_in_stat507);
					stat_seq();
					state._fsp--;
					dbg.location(98,67);
					match(input,ENDDO_KEY,FOLLOW_ENDDO_KEY_in_stat509); dbg.location(98,77);
				...
				case 4 :
					...
					{
					dbg.location(99,6);
					match(input,ID,FOLLOW_ID_in_stat518); dbg.location(99,9);
					...
					switch (alt17) {
						case 1 :
							...
							state._fsp--;
							dbg.location(99,22);
							match(input,ASSIGN,FOLLOW_ASSIGN_in_stat524); dbg.location(99,29);
				...
				case 5 :
					...
					{
					dbg.location(100,4);
					match(input,BREAK_KEY,FOLLOW_BREAK_KEY_in_stat541); dbg.location(100,14);
				...
				case 6 :
					...
					{
					dbg.location(101,4);
					match(input,RETURN_KEY,FOLLOW_RETURN_KEY_in_stat548); dbg.location(101,15);
		...
		try {
			...
			switch (alt20) {
				...
				case 2 :
					...
					{
					dbg.location(105,21);
					match(input,ID,FOLLOW_ID_in_expr575); dbg.location(105,24);
				...
				case 3 :
					...
					{
					dbg.location(105,54);
					match(input,LPAREN,FOLLOW_LPAREN_in_expr585); dbg.location(105,61);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					dbg.location(124,10);
					match(input,COMMA,FOLLOW_COMMA_in_expr_list723); dbg.location(124,16);
	...
	public final void value() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(127,10);
			match(input,ID,FOLLOW_ID_in_value738); dbg.location(127,13);
		...
		try {
			...
			switch (alt24) {
				case 1 :
					...
					{
					dbg.location(129,4);
					match(input,LBRACK,FOLLOW_LBRACK_in_value_tail749); dbg.location(129,11);
					pushFollow(FOLLOW_index_expr_in_value_tail751);
					index_expr();
					state._fsp--;
					dbg.location(129,22);
					match(input,RBRACK,FOLLOW_RBRACK_in_value_tail753); dbg.location(129,29);
					...
					switch (alt23) {
						case 1 :
							...
							{
							dbg.location(129,30);
							match(input,LBRACK,FOLLOW_LBRACK_in_value_tail756); dbg.location(129,37);
	...
	public final void func_call_tail() throws RecognitionException {
		...
		try {
			...
			{
			dbg.location(146,5);
			match(input,LPAREN,FOLLOW_LPAREN_in_func_call_tail862); dbg.location(146,12);
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							dbg.location(150,11);
							match(input,COMMA_SPACE,FOLLOW_COMMA_SPACE_in_func_param_list884); dbg.location(150,23);
