// $ANTLR 3.5 C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g 2014-10-05 20:02:54
...
public class tigerParser extends Parser {
		...
		try {
			...
			switch (alt3) {
				...
				case 2 :
					...
					{
					match(input,VOID_KEY,FOLLOW_VOID_KEY_in_funct_declaration82); 
			...
			match(input,BEGIN_KEY,FOLLOW_BEGIN_KEY_in_funct_declaration94); 
			pushFollow(FOLLOW_block_list_in_funct_declaration96);
			block_list();
			state._fsp--;

			match(input,END_KEY,FOLLOW_END_KEY_in_funct_declaration98); 
	...
	public final void funct_declaration_tail() throws  {
		try {
			...
			{
			match(input,FUNCTION_KEY,FOLLOW_FUNCTION_KEY_in_funct_declaration_tail112); 
			match(input,ID,FOLLOW_ID_in_funct_declaration_tail114); 
			match(input,LPAREN,FOLLOW_LPAREN_in_funct_declaration_tail116); 
	...
	public final void main_function_tail() throws  {
		try {
			...
			{
			match(input,MAIN_KEY,FOLLOW_MAIN_KEY_in_main_function_tail132); 
			match(input,LPAREN,FOLLOW_LPAREN_in_main_function_tail134); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,COMMA,FOLLOW_COMMA_in_param_list169); 
	...
	public final void param() throws  {
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_param186); 
			match(input,COLON,FOLLOW_COLON_in_param188); 
	...
	public final void block() throws  {
		try {
			...
			{
			match(input,BEGIN_KEY,FOLLOW_BEGIN_KEY_in_block231); 
			...
			match(input,END_KEY,FOLLOW_END_KEY_in_block237); 
	...
	public final void type_declaration() throws  {
		try {
			...
			{
			match(input,TYPE_KEY,FOLLOW_TYPE_KEY_in_type_declaration292); 
			match(input,ID,FOLLOW_ID_in_type_declaration294); 
			match(input,EQ,FOLLOW_EQ_in_type_declaration296); 
		...
		try {
			...
			switch (alt11) {
				...
				case 2 :
					...
					{
					match(input,ARRAY_KEY,FOLLOW_ARRAY_KEY_in_type316); 
					...
					switch (alt10) {
						case 1 :
							...
							{
							match(input,LBRACK,FOLLOW_LBRACK_in_type325); 
							match(input,INTLIT,FOLLOW_INTLIT_in_type327); 
					...
					match(input,OF_KEY,FOLLOW_OF_KEY_in_type333); 
	...
	public final void var_declaration() throws  {
		try {
			...
			{
			match(input,VAR_KEY,FOLLOW_VAR_KEY_in_var_declaration378); 
			pushFollow(FOLLOW_id_list_in_var_declaration380);
			id_list();
			state._fsp--;

			match(input,COLON,FOLLOW_COLON_in_var_declaration382); 
	...
	public final void id_list() throws  {
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_id_list398); 
		...
		try {
			...
			switch (alt14) {
				...
				case 2 :
					...
					{
					match(input,ASSIGN,FOLLOW_ASSIGN_in_optional_init430); 
		...
		try {
			...
			switch (alt18) {
				case 1 :
					...
					{
					match(input,IF_KEY,FOLLOW_IF_KEY_in_stat457); 
					pushFollow(FOLLOW_expr_in_stat459);
					expr();
					state._fsp--;

					match(input,THEN_KEY,FOLLOW_THEN_KEY_in_stat461); 
					...
					switch (alt16) {
						case 1 :
							...
							{
							match(input,ENDIF_KEY,FOLLOW_ENDIF_KEY_in_stat466); 
						...
						case 2 :
							...
							{
							match(input,ELSE_KEY,FOLLOW_ELSE_KEY_in_stat470); 
							pushFollow(FOLLOW_stat_seq_in_stat472);
							stat_seq();
							state._fsp--;

							match(input,ENDIF_KEY,FOLLOW_ENDIF_KEY_in_stat474); 
				...
				case 2 :
					...
					{
					match(input,WHILE_KEY,FOLLOW_WHILE_KEY_in_stat482); 
					pushFollow(FOLLOW_expr_in_stat484);
					expr();
					state._fsp--;

					match(input,DO_KEY,FOLLOW_DO_KEY_in_stat486); 
					pushFollow(FOLLOW_stat_seq_in_stat488);
					stat_seq();
					state._fsp--;

					match(input,ENDDO_KEY,FOLLOW_ENDDO_KEY_in_stat490); 
				...
				case 3 :
					...
					{
					match(input,FOR_KEY,FOLLOW_FOR_KEY_in_stat497); 
					match(input,ID,FOLLOW_ID_in_stat499); 
					match(input,ASSIGN,FOLLOW_ASSIGN_in_stat501); 
					pushFollow(FOLLOW_index_expr_in_stat503);
					index_expr();
					state._fsp--;

					match(input,TO_KEY,FOLLOW_TO_KEY_in_stat505); 
					pushFollow(FOLLOW_index_expr_in_stat507);
					index_expr();
					state._fsp--;

					match(input,DO_KEY,FOLLOW_DO_KEY_in_stat509); 
					pushFollow(FOLLOW_stat_seq_in_stat511);
					stat_seq();
					state._fsp--;

					match(input,ENDDO_KEY,FOLLOW_ENDDO_KEY_in_stat513); 
				...
				case 4 :
					...
					{
					match(input,ID,FOLLOW_ID_in_stat522); 
					...
					switch (alt17) {
						case 1 :
							...
							match(input,ASSIGN,FOLLOW_ASSIGN_in_stat528); 
				...
				case 5 :
					...
					{
					match(input,BREAK_KEY,FOLLOW_BREAK_KEY_in_stat545); 
				...
				case 6 :
					...
					{
					match(input,RETURN_KEY,FOLLOW_RETURN_KEY_in_stat552); 
		...
		try {
			...
			switch (alt20) {
				...
				case 2 :
					...
					{
					match(input,ID,FOLLOW_ID_in_expr579); 
				...
				case 3 :
					...
					{
					match(input,LPAREN,FOLLOW_LPAREN_in_expr589); 
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					match(input,COMMA,FOLLOW_COMMA_in_expr_list724); 
	...
	public final void value() throws  {
		try {
			...
			{
			match(input,ID,FOLLOW_ID_in_value739); 
				...
				case 1 :
					...
					switch (alt23) {
						case 1 :
							...
							{
							match(input,LBRACK,FOLLOW_LBRACK_in_value_tail757); 
	...
	public final void func_call_tail() throws  {
		try {
			...
			{
			match(input,LPAREN,FOLLOW_LPAREN_in_func_call_tail863); 
				...
				case 1 :
					...
					while (true) {
						...
						case 1 :
							...
							{
							match(input,COMMA_SPACE,FOLLOW_COMMA_SPACE_in_func_param_list885); 
