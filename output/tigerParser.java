...
public class tigerParser extends Parser {
	...
	// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:135:1: return_func : type_id FUNCTION_KEY ID LPAREN param_list RPAREN BEGIN_KEY block_list block_end -> ^( ID type_id param_list block_list ) ;
	public final tigerParser.return_func_return return_func() throws RecognitionException {
		...
		try {
			// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:136:2: ( type_id FUNCTION_KEY ID LPAREN param_list RPAREN BEGIN_KEY block_list block_end -> ^( ID type_id param_list block_list ) )
			// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:136:4: type_id FUNCTION_KEY ID LPAREN param_list RPAREN BEGIN_KEY block_list block_end
			{
	...
	public final tigerParser.void_func_return void_func() throws RecognitionException {
		...
		try {
			// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:145:2: ( ( VOID_KEY FUNCTION_KEY )=> VOID_KEY FUNCTION_KEY ID LPAREN param_list RPAREN BEGIN_KEY block_list block_end -> ^( ID VOID_KEY param_list block_list ) | VOID_KEY MAIN_KEY LPAREN RPAREN BEGIN_KEY block_list block_end -> ^( MAIN_KEY block_list ) )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:145:4: ( VOID_KEY FUNCTION_KEY )=> VOID_KEY FUNCTION_KEY ID LPAREN param_list RPAREN BEGIN_KEY block_list block_end
					{
					...
					break;
				case 2 :
					// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:152:4: VOID_KEY MAIN_KEY LPAREN RPAREN BEGIN_KEY block_list block_end
					{
	...
	// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:160:1: block_end : END_KEY SEMI ;
	...
	// $ANTLR start "block"
	// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:186:1: block : BEGIN_KEY ( declaration_statement stat_seq ) block_end -> ^( AST_BLOCK ( declaration_statement )? stat_seq ) ;
	public final tigerParser.block_return block() throws RecognitionException {
		...
		try {
			// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:187:4: ( BEGIN_KEY ( declaration_statement stat_seq ) block_end -> ^( AST_BLOCK ( declaration_statement )? stat_seq ) )
			// C:\\Users\\Jinhai Steakhouse\\OneDrive\\College\\CS 4240\\tiger-compiler\\tiger.g:187:6: BEGIN_KEY ( declaration_statement stat_seq ) block_end
			{
		...
		try {
			...
			switch (alt12) {
				...
				case 2 :
					...
					// AST REWRITE
					// elements: id_list, ASSIGN, COLON, UNSIGNED_INTLIT, type_id
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
		...
		try {
			...
			switch (alt16) {
				case 1 :
					...
					// AST REWRITE
					// elements: expr, ELSE_KEY, stat_seq, IF_KEY, stat_seq
					// token labels: 
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
	...
	public final tigerParser.for_stat_return for_stat() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: index_expr, index_expr, TO_KEY, stat_seq, FOR_KEY, ASSIGN, ID
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
